                    ...
                    >
                      <div className="h-64 overflow-hidden">
                        <img
                          src={imageUrl}
                          alt={title}
                          className="h-full w-full object-cover hover:scale-110 transition-all ease-in-out duration-1000"
                        />
                      </div>
                      ...
                      <p className="text-sm font-semibold absolute bottom-0 left-0 text-gray-500 flex bg-[#ebb661] w-full   justify-between items-center">
                      <Link
                        to={`/blog/${slug}`}
                        className="text-white hover:text-blue-100 uppercase   cursor-pointer  px-8 py-3"
                      >
                        Read More +
                      </Link>
                    </p>
