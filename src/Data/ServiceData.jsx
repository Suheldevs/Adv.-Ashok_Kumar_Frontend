  ...
  features: [
    {
      ...
      detail: "Quick legal action for securing regular and anticipatory bail in criminal cases, ensuring timely protection of your rights."
    },
    {
      title: "Criminal Trial Representation",
      detail: "Expert defense and prosecution representation in Sessions Courts and High Courts for a wide range of criminal offences."
    },
    {
      title: "FIR Quashing",
      detail: "Legal assistance for quashing false or baseless FIRs to prevent unnecessary harassment and legal trouble."
    },
    {
      title: "Defense in IPC Offences",
      detail: "Robust representation in cases involving serious charges under the Indian Penal Code, including assault, theft, cheating, and more."
    },
    {
      title: "White-Collar Crimes",
      detail: "Legal support in economic offences such as fraud, embezzlement, forgery, cybercrime, and corporate criminal liability."
    },
    {
      title: "Criminal Appeals & Revisions",
      detail: "Filing and arguing criminal appeals, revisions, and review petitions in higher courts with precision and judicial insight."
    },
    {
      title: "NDPS & POCSO Cases",
      detail: "Specialized defense in sensitive cases under the Narcotic Drugs and Psychotropic Substances Act and the Protection of Children from Sexual Offences Act."
    },
    {
      title: "Preventive Detention Matters",
      detail: "Challenging preventive detention orders and safeguarding constitutional rights through writ petitions and legal remedies."
    }
  ],
  ...
  features: [
    {
      ...
      detail: "Expert handling of title disputes, partition suits, property possession claims, encroachments, and adverse possession matters."
    },
    {
      title: "Inheritance & Succession",
      detail: "Legal advice and representation in inheritance disputes, will contestation, probate applications, and succession certificate proceedings."
    },
    {
      title: "Breach of Contract",
      detail: "Filing or defending civil suits involving contract breaches, agreements violations, and damages claims."
    },
    {
      title: "Recovery of Money",
      detail: "Legal action for recovery of unpaid dues, dishonoured cheques, and financial claims under contractual obligations."
    },
    {
      title: "Tenant-Landlord Disputes",
      detail: "Resolution of rent control matters, eviction suits, and lease agreement conflicts under tenancy laws."
    },
    {
      title: "Injunctions & Stay Orders",
      detail: "Urgent reliefs through temporary/permanent injunctions and stay orders to protect your legal rights and property."
    },
    {
      title: "Declaration & Specific Performance",
      detail: "Filing suits for declaration of legal rights and enforcement of contracts through specific performance orders."
    },
    {
      title: "Civil Appeals & Revisions",
      detail: "Expert drafting and argument in appellate and revision matters before civil and high courts."
    }
  ],
  ...
  faqs: [
    {
      ...
      answer: "Your case will be personally overseen by Retd. Judge Ashok Kumar, who brings over 35 years of legal and judicial experience in family law."
    },
    {
      question: "What types of divorce do you handle?",
      answer: "We assist in both mutual consent divorces and contested divorce cases based on grounds such as cruelty, adultery, desertion, and mental illness."
    },
    {
      question: "Do you provide support for child custody issues?",
      answer: "Yes. We represent clients in custody battles, joint parenting plans, and guardianship matters, with the child's welfare as the priority."
    },
    {
      question: "Is mediation an option in family disputes?",
      answer: "Absolutely. We encourage amicable resolution through mediation to avoid emotional strain and prolonged litigation."
    },
    {
      question: "What makes Judge Ashok Kumar's approach unique?",
      answer: "His compassionate, discreet, and deeply experienced approach ensures dignity, confidentiality, and strong representation in emotionally challenging cases."
    }
  ]
},
 {
  ...
  features: [
    {
      ...
      detail: "Thorough examination of property documents to confirm clear title, ownership history, and encumbrance status before purchase or transfer."
    },
    {
      title: "Property Disputes & Litigation",
      detail: "Representation in civil courts for disputes involving ownership, possession, partition, succession, and boundary disagreements."
    },
    {
      title: "Ancestral Property & Partition",
      detail: "Expert handling of joint family property partition suits and resolution of inheritance conflicts among legal heirs."
    },
    {
      title: "Sale Deed, Lease & Agreement Drafting",
      detail: "Drafting and vetting of property-related legal documents – including sale deeds, gift deeds, lease agreements, and power of attorney."
    },
    {
      title: "Landlord-Tenant Disputes",
      detail: "Legal remedies for eviction, non-payment of rent, unauthorized occupation, and breach of rental agreements under tenancy laws."
    },
    {
      title: "Mutation, Registration & Stamp Duty",
      detail: "Assistance with property registration, mutation processes, and advice on applicable stamp duties and local registration laws."
    },
    {
      title: "Possession & Injunction Matters",
      detail: "Legal action to reclaim possession or seek injunctions in cases of trespass, illegal occupation, or encroachment."
    },
    {
      title: "Property Appeals & Revisions",
      detail: "Filing appeals and revisions in higher courts against property judgments or lower court decisions."
    }
  ],
  ...
  features: [
    {
      ...
      detail: "Expert guidance on compliance with the Companies Act, 2013 – including incorporation, board governance, shareholder rights, and regulatory filings."
    },
    {
      title: "Contract Drafting & Negotiation",
      detail: "Drafting, vetting, and negotiating various commercial agreements – including joint ventures, NDAs, vendor contracts, service agreements, and MoUs."
    },
    {
      title: "Corporate Compliance & Regulatory Matters",
      detail: "Ensuring adherence to statutory and regulatory requirements including SEBI, RBI, MCA filings, FDI compliance, and CSR obligations."
    },
    {
      title: "Commercial Dispute Resolution",
      detail: "Representation in civil courts, commercial courts, and arbitration proceedings related to business disputes and contractual breaches."
    },
    {
      title: "Banking & Financial Litigation",
      detail: "Handling cases involving loan defaults, guarantee enforcement, recovery proceedings, and disputes under the SARFAESI Act or Insolvency & Bankruptcy Code (IBC)."
    },
    {
      title: "Intellectual Property (IP) Protection",
      detail: "Legal advisory on trademark, copyright, and patent registration, protection, and infringement litigation."
    },
    {
      title: "Mergers, Acquisitions & Corporate Restructuring",
      detail: "Legal due diligence, transaction documentation, and compliance support for mergers, acquisitions, and restructuring."
    },
    {
      title: "Risk Management & Legal Audit",
      detail: "Identifying legal risks and conducting internal legal audits to ensure policy adherence and reduce exposure."
    }
  ],
  ...
  features: [
    {
      ...
      detail: "Drafting of sale deeds, gift deeds, agreements, MoUs, lease & rental agreements, wills, affidavits, and power of attorney documents."
    },
    {
      title: "Legal Notices & Replies",
      detail: "Preparation of notices for recovery, breach, defamation, termination, and reply drafting for matrimonial, civil, and commercial matters."
    },
    {
      title: "Expert Legal Opinions",
      detail: "Document-based legal analysis and written legal opinions for use in litigation, business transactions, and personal matters."
    },
    {
      title: "Court Documentation & Filing",
      detail: "Drafting petitions, plaints, replies, affidavits, rejoinders, and appeals for court filing across various jurisdictions."
    }
  ],
  ...
  faqs: [
    {
      ...
      answer: "Yes, we draft sale deeds, MoUs, NDAs, rental agreements, wills, affidavits, and more tailored to your specific needs."
    },
    {
      question: "Can I get a legal opinion on a property or contract?",
      answer: "Absolutely. We provide expert legal opinions after reviewing relevant documents, laws, and precedents."
    }
  ]
}
