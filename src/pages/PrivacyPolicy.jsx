...
const PrivacyPolicy = () => {
  return (
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-4xl w-full bg-white shadow-lg rounded-2xl p-8 md:p-12 border border-gray-200">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mt-6 mb-2">1. No Personal Data Collection</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mt-6 mb-2">2. Cookies</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mt-6 mb-2">3. Third-Party Links</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mt-6 mb-2">4. Security</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mt-6 mb-2">5. Legal Compliance</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mt-6 mb-2">6. Changes to This Policy</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mt-6 mb-2">7. Contact</h2>
